 ...
 * @author Angus
 */
public class OptionsSetting extends javax.swing.JFrame {

    /**
     * Creates new OptionsSetting
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OptionsSetting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OptionsSetting().setVisible(true);
            }
        });
    }
